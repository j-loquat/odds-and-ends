...
print('I am thinking of a %s-digit number. Each digit is unique. Try to guess what it is.' %(NUM_DIGITS))
...
while True:
    ...
    if pyip.inputYesNo('Do you want to play again? (yes or no): ') == 'no':
        break
